  ...
  return (
    <HelmetProvider>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover the latest new movies on justmovies. Explore the newest releases and find your next favorite film."
        />
              ...
              {listMovies.map((movie) => (
                ...
                >
                  <div>
                    ...
                    />
                    <h2 className="newmovies_container_card-title">
                      {movie.title}
                    </h2>
                  </div>
                </Link>
