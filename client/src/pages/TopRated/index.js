  ...
  return (
    <HelmetProvider>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover the top-rated movies on justmovies. Check out the best-rated movies of all time and find new favorites."
        />
        <meta
          name="keywords"
          content="top-rated movies, best-rated movies, highest-rated films"
        />
      </Helmet>
                ...
                >
                  <div>
                    <img
                      ...
                      alt={
                        rated.title
                          ? `Poster of the movie ${rated.title}`
                          : "Image unavailable"
                      }
                    />
                    <h2 className="ratedmovie_container_card-title">
                      {rated.title}
                    </h2>
                  </div>
                </Link>
