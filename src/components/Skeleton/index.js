...
import { popularcarouselsetting, detailscarouselsetting } from "../../mocks/carouselsettings";
		...
		<div className="details_container">
          <div className="details_container_movie">
            ...
            <span className="details_container_movie-details">
              <Skeleton className="details_container_movie-details-title" variant="text" count={1} />
              <Skeleton className="details_container_movie-details-releasedate" variant="text" count={1} />
            </span>
          </div>

          <div className="details_container_movie-synopsis">
            <hr />
            <Skeleton className="details_container_movie-synopsis-paragraph" variant="text" count={7} />
          </div>
